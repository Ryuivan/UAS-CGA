...
public class Menu_Controller : MonoBehaviour {
	...
	public string _webpageURL = "https://github.com/Ryuivan/UAS-CGA";
	...
	public void PlayGame()
	{
		...
		// Validasi untuk memastikan SampleScene dimuat
		string sceneToLoad = string.IsNullOrEmpty(_sceneToLoadOnPlay) ? "SampleScene" : _sceneToLoadOnPlay;
		if (sceneToLoad != "SampleScene")
		{
			Debug.LogWarning("Scene yang dimuat telah diubah! Mengembalikan ke SampleScene.");
